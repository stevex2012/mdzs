...
const caseConfig = {
    ...
    '1':[
        ...
        {
            img: '../static/img/case/guolinxigu (1).jpg',
            name: '果林溪谷',
            square:'200平米',
            style:'现代',
            time:'2017-04-23 15:49:39',
            imgList:[
                '../static/img/case/guolinxigu (1).jpg',
                '../static/img/case/guolinxigu (2).jpg',
                '../static/img/case/guolinxigu (3).jpg',
                '../static/img/case/guolinxigu (4).jpg',
                '../static/img/case/guolinxigu (5).jpg',
                '../static/img/case/guolinxigu (6).jpg',
                '../static/img/case/guolinxigu (7).jpg',
                '../static/img/case/guolinxigu (8).jpg',
                '../static/img/case/guolinxigu (9).jpg',
                '../static/img/case/guolinxigu (10).jpg',
                '../static/img/case/guolinxigu (11).jpg',
            ],
            id: '17',
        },
        {
            img: '../static/img/case/shangshanxi (1).jpg',
            name: '上善栖',
            square:'120平米',
            style:'现代',
            time:'2017-04-23 15:49:39',
            imgList:[
                '../static/img/case/shangshanxi (1).jpg',
                '../static/img/case/shangshanxi (2).jpg',
                '../static/img/case/shangshanxi (3).jpg',
                '../static/img/case/shangshanxi (4).jpg',
                '../static/img/case/shangshanxi (5).jpg',
                '../static/img/case/shangshanxi (6).jpg',
                '../static/img/case/guolinxigu (7).jpg',
                '../static/img/case/shangshanxi (8).jpg',
                '../static/img/case/shangshanxi (9).jpg',
                '../static/img/case/shangshanxi (10).jpg',
                '../static/img/case/shangshanxi (11).jpg',
                '../static/img/case/shangshanxi (12).jpg',
            ],
            id: '18',
        }
